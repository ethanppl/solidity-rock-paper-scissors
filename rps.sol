...
contract rps {
    ...
    function revealChoice(Choice choice, uint nonce) public {
        require(block.number >= 100 && block.number < 200);
    ...
    function refundDeposit() public {
        bool didNotSubmitHash = block.number >= 100 && (aliceHash == 0 || bobHash == 0);
        bool didNotRevealChoice = block.number >= 200 && (aliceChoice == Choice.Empty || bobChoice == Choice.Empty);
